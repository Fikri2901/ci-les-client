...
<head>
    <meta charset="utf-8">
    <title>SMART CLASS NUSANTARA</title>
    ...
    <link href="<?= base_url(); ?>assets/user/lib/fancybox/fancybox.css" rel="stylesheet">

    <!-- Main Stylesheet File -->
    <link href="<?= base_url(); ?>assets/user/css/style.css" rel="stylesheet">

    <link rel="prefetch" href="<?= base_url(); ?>assets/user/img/zoom.png">
        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    <li class="active"><a href="<?= base_url(); ?>index/indexUser">Home</a></li>
                    <li><a href="<?= base_url(); ?>index/pengajar">Pengajar</a></li>
                    <li><a href="<?= base_url(); ?>index/jadwal">Jadwal</a></li>
                    <li><a href="<?= base_url(); ?>index/daftar">Data Pendaftar</a></li>
                    <li><a href="<?= base_url(); ?>index/index">Logout</a></li>
                </ul>
            </div>
            <!--/.nav-collapse -->
        </div>
