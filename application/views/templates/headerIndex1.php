        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="#about-us" class="smoothscroll">Pengajar</a></li>
                    <li><a href="#about-us2" class="smoothscroll">Jadwal</a></li>
                    <li><a href="<?= base_url(); ?>index/daftar">Data Pendaftar</a></li>
                    <li><a href="<?= base_url(); ?>masuk/loginles/logout">Logout</a></li>
                </ul>
            </div>
            <!--/.nav-collapse -->
        </div>
