...
<div class="slide story" id="about-us" data-slide="2">
    ...
    <!-- /container -->
    <a href="<?= base_url(); ?>index/pengajar"><button type="button" class="btn btn-default">Daftar pengajar</button></a>
</div>
<!-- /slide2 -->
...
<div class="slide story" id="about-us2" data-slide="2">
    ...
    <!-- /container -->
    <a href="<?= base_url(); ?>index/jadwal"><button type="button" class="btn btn-default">Daftar Jadwal</button></a>
</div>
<!-- /slide3 -->
